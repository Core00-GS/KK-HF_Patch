...
Source: "Input\KK_PregnancyPlus.cfg";                  DestDir: "{app}\BepInEx\config"; DestName: "KK_PregnancyPlus.cfg";      Flags: solidbreak;   Components: Content\KKABMX\Pregnancy\KK_PregnancyPlus
#endif
